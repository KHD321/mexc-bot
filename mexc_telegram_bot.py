...
DEFAULT_COINS = [
    ...
    "XRP/USDT", "DOGE/USDT", "PAXG/USDT", "PEPE/USDT",
    "AVAX/USDT", "ADA/USDT"
]
...
async def cmd_set_sltp(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if len(ctx.args) < 4:
        await update.message.reply_text(
            "İstifadə: `/sltp BTC/USDT 0.001 90000 105000`\n_(symbol miqdar stop\\_loss take\\_profit)_",
            parse_mode="Markdown"
        )
        return
    try:
...
async def button_handler(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "balance":
        ...
        await query.edit_message_text("Analiz: `/analyze BTC/USDT 1h`\nTimeframelər: 1m 5m 15m 1h 4h 1d", parse_mode="Markdown")
